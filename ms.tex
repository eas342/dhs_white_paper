...
The noise in the DHS spectra over 1.1 -- 1.9$\mu$m at the given saturation limit for a 1-hour transit is shown in column 4 at native R $\sim$ \DHSresApprox\ resolution.}
\end{table}

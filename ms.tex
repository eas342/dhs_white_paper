...
\tablecomments{The approximate pupil coverage of the 10 DHS grisms compared to the total primary collecting area.}\label{tab:pupfrac}
\end{table}
...
\caption{Posterior distributions an MCMC run of HD209458b with the DHS (blue) laid on top of that for the NIRCam girsms only without the DHS (gray).

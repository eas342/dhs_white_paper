...
We use CHIMERA and a MCMC retrieval to recover the individual atmospheric abundances of the simulated spectrum.
...
If the region from 2-2.23$\mu$m is highly desirable such as for measuring the CH$_4$ feature shown in Figure \ref{fig:HATp12spec}, the DHS can be used with a F200W filter (1.75 to 2.23$\mu$m half maximum) to partially fill in the gap between the short to long wavelength channels, though the grism blaze function drops off above 2.0$\mu$m, shown in Section \ref{sec:layout}. 

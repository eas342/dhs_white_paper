...
NIRCam's long-wavelength channel includes grisms that cover 2.4$\mu$m to 5.0$\mu$m with two observations at $R = 1200 - 1550$ and it has already been approved for wide field slitless spectroscopy.
...
In this white paper, we argue for the inclusion of the DHS mode to fully take advantage of two NIRCam channels to maximize JWST's science potential for transiting planets.

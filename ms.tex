...
Table \ref{tab:pupfrac} lists the fractional pupil coverage of each DHS spectrum where 1.00 would use the entire pupil and thus take advantage of the maximum JWST collecting area.
...
\begin{figure}[!ht]
\includegraphics[width=0.49\textwidth]{example_ap_sizes.pdf}
...
\begin{figure}[!ht]
\includegraphics[width=0.49\textwidth]{NIRCam_grism_max_exp.pdf}

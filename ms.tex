...
\centering
\subfloat{
	\includegraphics[width=0.4\textwidth]{HD209458b_solar_clear_1trans_corner.png}
	\caption{HD209458b}
	\label{fig:corner209}
	}
\subfloat{
	\includegraphics[width=0.4\textwidth]{HAT-P-12b_kmr_cloudy_corner.png}
	\caption{HAT-P-12b}
...
\begin{figure*}
\centering
\includegraphics[width=1.0\textwidth]{grism_pos_for_max_wcoverage.pdf}
